...
int MD5HexToChar(  unsigned char digest[16],  char MD5_Char[40]  )
{
        //by black
        ...
        for (i = 0; i < 16; i++)
        {
                MD5_Char[i * 2] = HexList[  digest[i] / 16  ];
                MD5_Char[i * 2 + 1] = HexList[ digest[i] % 16 ];

                /*
                temp=digest[i] / 16 ;

                MD5_Char[i * 2] = HexList[   temp  ];

                temp=digest[i] % 16;

                MD5_Char[i * 2 + 1] = HexList[ temp ];*/
